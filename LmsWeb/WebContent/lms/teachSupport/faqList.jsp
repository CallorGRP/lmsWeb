	...
	<%@ include file="../../template/lms_header.jspf" %>
		...
		<div class="row">
			...
			<div id="btn" class="grid04">
				<form method="get">
					<button type="submit" formaction="faqList.bit">조회</button>
					<button type="submit" formaction="faqAdd.bit">신규</button>
					<button type="submit" formaction="faqDelete.bit">삭제</button>
				</form>
			</div>
		</div>
		...
		%>
			<form method="post" action="faqDetail.bit" >
