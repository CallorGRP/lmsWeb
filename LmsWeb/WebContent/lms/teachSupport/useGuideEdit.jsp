...
<body>
	<%@ include file="../../template/lms_header.jspf" %>
		...
		<div class="row">
			...
			<div id="btn" class="grid04">
					...
					<button type="submit" formaction="useGuideEdit.bit">저장</button>
	...
	<%
		...
		bean=(BbsDto)session.getAttribute("useGuideDetail");
		session.setAttribute("useGuideDetail", null);
		session.setAttribute("useGuideDetail", bean);
	%>
		<div class="row">
