...
<body>
	<%@ include file="../../template/lms_header.jspf" %>
		...
		<div class="row">
			...
			<div id="btn" class="grid04">
					...
					<button type="submit" formaction="noticeEdit.bit">저장</button>
	...
	<%
		...
		bean=(BbsDto)session.getAttribute("noticeDetail");
		session.setAttribute("noticeDetail", null);
		session.setAttribute("noticeDetail", bean);
	%>
		<div class="row">
