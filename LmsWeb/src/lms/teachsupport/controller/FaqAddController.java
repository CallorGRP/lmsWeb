...
public class FaqAddController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		RequestDispatcher rd = req.getRequestDispatcher("/lms/teachSupport/faqAdd.jsp");
		rd.forward(req, resp);
	}
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		BbsDto bean= (BbsDto)hs.getAttribute("FaqAdd");
		hs.setAttribute("FaqAdd", null);
		int subnum=0;
		...
		bd.add("AQ", subnum, req.getParameter("sub"), bean.getHcode(), bean.getId(), req.getParameter("content"));
