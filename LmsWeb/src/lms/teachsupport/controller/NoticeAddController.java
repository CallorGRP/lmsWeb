...
public class NoticeAddController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		RequestDispatcher rd = req.getRequestDispatcher("/lms/teachSupport/noticeAdd.jsp");
		rd.forward(req, resp);
	}
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		BbsDto bean= (BbsDto)hs.getAttribute("NoticeAdd");
		hs.setAttribute("NoticeAdd", null);
		int subnum=0;
		...
		bd.add("NO", subnum, req.getParameter("sub"), bean.getHcode(), bean.getId(), req.getParameter("content"));
